...
public class PartyController {
  ...
  public ResponseEntity<ApiResponse> getAllParties() {
    ...
    return ResponseEntity.ok(new ApiResponse("Parties fetched", parties));
  }
  ...
  public ResponseEntity<ApiResponse> getPartyById(@PathVariable Long partyId) {
    try {
      ...
      return ResponseEntity.ok(new ApiResponse("Party fetched successfully", party));
  ...
  public ResponseEntity<ApiResponse> createParty() {
    ...
    return ResponseEntity.ok(new ApiResponse("Party created successfully", createdParty));
  }
  ...
  public ResponseEntity<ApiResponse> updateParty(@RequestBody PartyUpdateDto updatedParty, @RequestParam Long partyId) {
    try {
      ...
      return ResponseEntity.ok(new ApiResponse("Party updated successfully", theParty));
    } catch (ResourceNotFoundExceptions e) {
      return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiResponse(e.getMessage(), null));
    }
  }
